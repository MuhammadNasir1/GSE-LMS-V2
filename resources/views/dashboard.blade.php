    ...
    <div class="md:mx-6 mx-2 md:mt-16 mt-4">
        ...
        <div class="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 w-full mt-4 ">
            @if (session('user_det')['role'] == 'admin')
                <div
                    class="flex border border-primary    gap-4 justify-between items-center h-[100px] rounded-xl px-4 w-full bg-white">
                    <div>
                        <h3 class="font-bold text-4xl text-black">{{ $total_user }}</h3>
                        <p class="text-gray-800 text-lg">Users</p>
                    </div>
                    <div class="h-16 w-16 flex-shrink-0 bg-black rounded-full flex justify-center items-center">
            ...
            @endif
            <div
                class="flex border border-purple-700  gap-4 justify-between items-center h-[100px]  rounded-xl px-4 w-full bg-white">
                <div>
                    <h3 class="font-bold text-4xl text-purple-700">{{ $submission }}</h3>
                    <p class="text-gray-800 text-lg">Submission</p>
                </div>
                <div class="h-16 w-16 flex-shrink-0 bg-purple-700 rounded-full flex items-center justify-center">
            ...
            <div
                class="flex border border-yellow-300  gap-4 justify-between items-center h-[100px] rounded-xl px-4 w-full bg-white">
                <div>
                    <h3 class="font-bold text-4xl text-yellow-300">{{ $pending }}</h3>
                    <p class="text-gray-800 text-lg">pending Units</p>
                </div>
                <div class="h-16 w-16 flex-shrink-0 bg-yellow-300 rounded-full flex justify-center items-center">
            ...
            <div
                class="flex border border-secondary  gap-4 justify-between items-center h-[100px] rounded-xl px-4 w-full bg-white">
                <div>
                    <h3 class="font-bold text-4xl text-secondary">{{ $approved }}</h3>
                    <p class="text-gray-800 text-lg"> Approved</p>
                </div>
                <div class="h-16 w-16 flex-shrink-0 bg-secondary rounded-full flex justify-center  items-center">
            ...
            <div
                class="flex border border-red-600    gap-4 justify-between items-center h-[100px] rounded-xl px-4 w-full bg-white">
                <div>
                    <h3 class="font-bold text-4xl text-red-600">{{ $rejection }}</h3>
                    <p class="text-gray-800 text-lg">Rejection</p>
                </div>
                <div class="h-16 w-16 flex-shrink-0 bg-white rounded-full flex justify-center items-center">
        ...
        <div class="flex lg:flex-row flex-col gap-4 mt-6">
            <div class="lg:w-[65%] w-full bg-white shadow-med   rounded-xl overflow-x-auto">
                @if (session('user_det')['role'] == 'admin')
