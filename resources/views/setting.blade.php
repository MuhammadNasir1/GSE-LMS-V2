...
@section('content')
    <div class="lg:mx-4 mt-12">
        ...
        <div id="reloadDiv" class="shadow-dark mt-3  rounded-xl pt-8  bg-white">
            <form id="postDataForm" url="../updateSettings" method="post" enctype="multipart/form-data">
                ...
                <div class="p-8">
                    <div class="flex items-center flex-col gap-2">
                        <div class="h-[200px] w-[200px] relative  rounded-[50%]">
                            <img id="img_view" height="200px" width="200px"
                                ...
                                src=" {{ asset($user->user_image ?? 'assets/logo/logo-bg-white.png') }}" alt="user">
                            <input class="absolute top-0 opacity-0     h-[200px] w-[200px] z-50 cursor-pointer "
                    ...
                    <div class="mt-10  flex justify-end">
                        <button class="bg-customOrange  text-white h-12 px-3 rounded-[6px]  shadow-sm font-semibold "
                            id="addBtn">
