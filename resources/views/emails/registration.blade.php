...
<head>
    ...
    <!--[if !mso]>-->
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&amp;family=Sofia+Sans:wght@700&amp;family=Open+Sans:wght@400;500;600;700&amp;display=swap"
...
<body id=body class=t52 style="min-width:100%;Margin:0px;padding:0px;background-color:#FFFFFF;">
    <div class=t51 style="background-color:#FFFFFF;">
        <table role=presentation width=100% cellpadding=0 cellspacing=0 border=0 align=center>
            <tr>
                <td class=t50 style="font-size:0;line-height:0;mso-line-height-rule:exactly;background-color:#FFFFFF;"
                                ...
                                <table class=t48 role=presentation cellpadding=0 cellspacing=0
                                    ...
                                    <tr>
                                        ...
                                        <td class=t47
                                            ...
                                            <!--<![endif]-->
                                            <table class=t46 role=presentation cellpadding=0 cellspacing=0 width=100%
                                                style="width:100%;">
                                                <tr>
                                                    <td class=t45 style="padding:44px 42px 32px 42px;">
                                                            ...
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t4 role=presentation cellpadding=0
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td width=238 class=t3 style="width:238px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class=t3 style="width:238px;">
                                                                                <!--<![endif]-->
                                                            ...
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t9 role=presentation cellpadding=0
                                                                        cellspacing=0
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <!--[if mso]>
<td width=514 class=t8 style="border-bottom:1px solid #EFF1F4;width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class=t8
                                                            ...
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t15 role=presentation cellpadding=0
                                                                        cellspacing=0
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <!--[if mso]>
<td width=514 class=t14 style="border-bottom:1px solid #EFF1F4;width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class=t14
                                                                                style="border-bottom:1px solid #EFF1F4;width:514px;">
                                                            ...
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t21 role=presentation cellpadding=0
                                                                        cellspacing=0
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <!--[if mso]>
...
<![endif]-->
                                                            ...
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t27 role=presentation cellpadding=0
                                                                        cellspacing=0
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class=t29
                                                                        style="mso-line-height-rule:exactly;mso-line-height-alt:74px;line-height:74px;font-size:1px;display:block;">
                                                                        &nbsp;&nbsp;</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t33 role=presentation cellpadding=0
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td class=t32 style="background-color:#FFFFFF;width:auto;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class=t32
                                                                                style="background-color:#FFFFFF;width:auto;">
                                                                                <!--<![endif]-->
                                                                                <table class=t31 role=presentation
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class=t30
                                                                                            style="text-align:center;line-height:20px;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                                            <span class=t28
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class=t39
                                                                        style="mso-line-height-rule:exactly;mso-line-height-alt:3px;line-height:3px;font-size:1px;display:block;">
                                                                        &nbsp;&nbsp;</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align=center>
                                                                    <table class=t43 role=presentation cellpadding=0
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td class=t42 style="background-color:#FFFFFF;width:auto;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class=t42
                                                                                style="background-color:#FFFFFF;width:auto;">
